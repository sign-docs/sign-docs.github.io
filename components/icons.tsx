...
export const SignatureIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
        <path d="M22 22a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2c0-1.1.9-2 2-2h12l6 6v14Z" />
        <path d="M14 2v4a2 2 0 0 0 2 2h4" />
        <path d="M8 12.5a2.5 2.5 0 1 1 5 0 2.5 2.5 0 1 0 5 0" />
    </svg>
);
...
export const HeaderIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-cyan-400">
        <path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
        <path d="M18.37 2.63 14 7l-1.59-1.59a2 2 0 0 1 0-2.82l.83-.83a2 2 0 0 1 2.82 0l2.31 2.31a2 2 0 0 1 0 2.82L17 8m-5 5-1.59-1.59a2 2 0 0 1 0-2.82l.83-.83a2 2 0 0 1 2.82 0l2.31 2.31a2 2 0 0 1 0 2.82L15 13" />
        <path d="m14 7 5 5" />
    </svg>
);
